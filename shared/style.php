    ...
    switch ($pageType) {
        case 'home':
            $navbarLink = '<a class="active item" href="./"><i class="home icon"></i>'.$s['home'].'</a>'.
                          ...
                          '<a class="item" href="newbuild.php"><i class="plus circle icon"></i>New build</a>'.
                          '<a class="item" target=_blank href="https://www.cnbbx.com/"><i class="question circle icon"></i>'.$s['faq'].'</a>';
        break;
        ...
        case 'newbuild':
            $navbarLink = '<a class="item" href="./"><i class="home icon"></i>'.$s['home'].'</a>'.
                          '<a class="item" href="known.php"><i class="download icon"></i>'.$s['downloads'].'</a>'.
                          '<a class="active item" href="newbuild.php"><i class="plus circle icon"></i>New build</a>'.
                          '<a class="item" target=_blank href="https://www.cnbbx.com/"><i class="question circle icon"></i>'.$s['faq'].'</a>';
        break;
